...
const Table = ({ data }) => {
    ...
    return (
        <div>
            ...
            {modal && <ModalneOkno spravy={sprava} id_primatelaSpravy={id_primatelaSpravy} id_prihlaseneho={id_prihlaseneho} zmenaModalu={zmenaModalu}/>} {/* Pass the id_odosielatelaSpravy */}
        </div>
    );
};
